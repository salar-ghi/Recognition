...
class FaceRecognition():
    ...
    def __init__(self):
        ...
        self.cam = cv2.VideoCapture(0 ,cv2.CAP_DSHOW,(cv2.CAP_PROP_HW_ACCELERATION, cv2.VIDEO_ACCELERATION_ANY))
        ...
        self.cam.set(cv2.CAP_PROP_FOURCC ,cv2.VideoWriter.fourcc('M','J','P','G'))
        self.cam.set(cv2.CAP_PROP_FRAME_WIDTH, resolutions[1][0])
        self.cam.set(cv2.CAP_PROP_FRAME_HEIGHT, resolutions[1][1])
        ...
        # self.t1 = Thread(target=self.encode_faces , daemon=True, args=())
        # self.t1.start()
